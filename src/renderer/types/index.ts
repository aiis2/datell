...
export interface ElectronAPI {
  savePdf: (args: { html: string; title: string; themeId?: string; layoutId?: string }) => Promise<boolean>;
  captureReport: (args: { html: string; title: string; themeId?: string; layoutId?: string }) => Promise<boolean>;
  ...
  exportHtmlBundle: (args: { html: string; title: string; mode: 'interactive' | 'static' }) => Promise<boolean>;
