...
| Platform | File | Notes |
|----------|------|-------|
| **Windows x64** | [`Datell-1.0.2-win-x64-portable.exe`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-win-x64-portable.exe) | Portable, no install needed |
| macOS x64 | [`Datell-1.0.2-mac-x64.dmg`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-mac-x64.dmg) | Intel Mac |
| macOS arm64 | [`Datell-1.0.2-mac-arm64.dmg`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-mac-arm64.dmg) | Apple Silicon (M1/M2/M3) |
| Linux x64 | [`Datell-1.0.2.AppImage`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2.AppImage) | Portable AppImage for most distros |
...
| 平台 | 文件 | 说明 |
|------|------|------|
| **Windows x64** | [`Datell-1.0.2-win-x64-portable.exe`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-win-x64-portable.exe) | 免安装，双击直接运行 |
| macOS x64 | [`Datell-1.0.2-mac-x64.dmg`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-mac-x64.dmg) | Intel Mac |
| macOS arm64 | [`Datell-1.0.2-mac-arm64.dmg`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2-mac-arm64.dmg) | Apple Silicon (M1/M2/M3) |
| Linux x64 | [`Datell-1.0.2.AppImage`](https://github.com/aiis2/datell/releases/download/v1.0.2/Datell-1.0.2.AppImage) | 适用于大多数发行版的便携 AppImage |
